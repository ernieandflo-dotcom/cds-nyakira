...
(function () {
  ...
  const i18n = {
    ...
    fr: {
      ...
      'terms.subtitle':     'Conditions d\'utilisation du site CDS Nyakira',
      'terms.updated':      'Dernière mise à jour : 14 août 2026',
      'terms.langNotice':   'Ce document est disponible en français et en anglais. En cas de divergence entre les deux versions, la version française fait foi. La traduction anglaise est fournie à titre informatif et peut être générée automatiquement.',
      'terms.s1.title':     '1. Objet du site',
      'terms.s1.body':      'Le présent site est une vitrine d\'information destinée à présenter le Centre De Santé (CDS) Nyakira, ses services, son historique et ses coordonnées. Il ne constitue pas une plateforme de réservation, de téléconsultation ni de dossier médical en ligne. Aucune information médicale personnelle ne doit être transmise via le formulaire de contact du site.',
      'terms.s2.title':     '2. Disponibilité et fiabilité',
      'terms.s2.body':      'CDS Nyakira s\'efforce d\'assurer une disponibilité continue de ses services, y compris en dehors des heures d\'ouverture habituelles. Toutefois, en raison de circonstances propres au contexte local (coupures d\'électricité, interruptions de réseau, indisponibilité ponctuelle de personnel ou de matériel), la continuité des services ne peut être garantie en tout temps. Les horaires affichés sur ce site sont fournis à titre indicatif et peuvent varier sans préavis.',
      'terms.s3.title':     '3. Formulaire de contact et données personnelles',
      'terms.s3.body':      'Les informations transmises via le formulaire de contact (nom, coordonnées, objet de la demande, message) sont utilisées uniquement pour répondre à votre demande. Elles ne sont ni vendues ni partagées avec des tiers à des fins commerciales, et sont conservées le temps nécessaire au traitement de votre demande.',
      'terms.s4.title':     '4. Absence de conseil médical à distance',
      'terms.s4.body':      'Le contenu de ce site est fourni à titre informatif uniquement et ne remplace pas une consultation médicale. En cas d\'urgence ou de besoin de soins, veuillez vous présenter directement à la clinique. Aucun diagnostic, traitement ou conseil médical personnalisé ne sera fourni par l\'intermédiaire de ce site ou de son formulaire de contact.',
      'terms.s5.title':     '5. Propriété du contenu',
      'terms.s5.body':      'Les textes, images, logos et éléments visuels présents sur ce site sont la propriété de CDS Nyakira ou de ses partenaires (GlobalGiving, BuDental Mission Association, Beauty Out of Dust, Texas A&M Dentistry), utilisés avec leur autorisation dans le cadre de la présentation des collaborations. Toute reproduction sans autorisation préalable est interdite.',
      'terms.s6.title':     '6. Droit applicable',
      'terms.s6.body':      'Les présents termes sont régis par le droit en vigueur en République du Burundi. Tout litige relatif à l\'utilisation de ce site sera soumis à la compétence des tribunaux burundais.',
      'terms.s7.title':     '7. Nous contacter',
      'terms.s7.body':      'Pour toute question relative aux présents termes et conditions, contactez-nous au +257 79 56 57 28 (téléphone/WhatsApp) ou à cdsnyakira@gmail.com.',
    },
    en: {
      'hero.kirundi':         'Ni ivuriro ryanyu',
      ...
      'terms.subtitle':     'Terms of use for the CDS Nyakira website',
      'terms.updated':      'Last updated: August 14, 2026',
      'terms.langNotice':   'This document is available in French and English. In case of discrepancy between the two versions, the French version shall prevail. The English translation is provided for informational purposes only and may be machine-generated.',
      'terms.s1.title':     '1. Purpose of the site',
      'terms.s1.body':      'This website is an informational showcase presenting the Centre De Santé (CDS) Nyakira, its services, history and contact details. It is not a booking platform, teleconsultation service, or online medical record. No personal medical information should be submitted through the site\'s contact form.',
      'terms.s2.title':     '2. Availability and reliability',
      'terms.s2.body':      'CDS Nyakira strives to ensure continuous availability of its services, including outside regular hours. However, due to local circumstances (power outages, network interruptions, temporary unavailability of staff or equipment), uninterrupted service cannot be guaranteed at all times. Hours displayed on this site are indicative and may change without notice.',
      'terms.s3.title':     '3. Contact form and personal data',
      'terms.s3.body':      'Information submitted through the contact form (name, contact details, subject, message) is used solely to respond to your request. It is not sold or shared with third parties for commercial purposes, and is retained only as long as necessary to process your request.',
      'terms.s4.title':     '4. No remote medical advice',
      'terms.s4.body':      'The content of this site is provided for informational purposes only and does not replace a medical consultation. In case of emergency or need for care, please visit the clinic directly. No diagnosis, treatment, or personalized medical advice will be provided through this site or its contact form.',
      'terms.s5.title':     '5. Content ownership',
      'terms.s5.body':      'The text, images, logos and visual elements on this site are the property of CDS Nyakira or its partners (GlobalGiving, BuDental Mission Association, Beauty Out of Dust, Texas A&M Dentistry), used with their permission in the context of presenting these collaborations. Any reproduction without prior authorization is prohibited.',
      'terms.s6.title':     '6. Governing law',
      'terms.s6.body':      'These terms are governed by the laws in force in the Republic of Burundi. Any dispute relating to the use of this site shall be subject to the jurisdiction of Burundian courts.',
      'terms.s7.title':     '7. Contact us',
      'terms.s7.body':      'For any questions regarding these terms and conditions, contact us at +257 79 56 57 28 (phone/WhatsApp) or at cdsnyakira@gmail.com.',
    },
